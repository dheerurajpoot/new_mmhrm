      ...
      <Card>
        <CardHeader>
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            {!isEditing && (
              <Button onClick={() => setIsEditing(true)} className="bg-gradient-to-r from-red-600 to-blue-600">
          ...
          {isEditing ? (
            <form onSubmit={handleSave} className="space-y-6">
              ...
              <div className="flex space-x-3">
                <Button type="submit" disabled={isSaving} className="bg-gradient-to-r from-red-600 to-blue-600">
            ...
            <div className="space-y-6">
              <div className="flex items-center space-x-4 p-4 bg-gradient-to-r from-red-50 to-blue-50 rounded-lg">
                ...
                <div>
                  <h3 className="text-xl font-semibold text-gray-900">{profile?.full_name || "No name provided"}</h3>
                  <p className="text-gray-600">{profile?.position || "No position assigned"}</p>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex items-center space-x-3 p-3 bg-gray-50 rounded-lg">
                    ...
                    <div>
                      ...
                      <p className="text-gray-900">{profile?.position || "Not assigned"}</p>
                    </div>
                  </div>
                </div>
              </div>
