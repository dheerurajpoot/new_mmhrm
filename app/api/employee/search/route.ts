...
export async function GET(request: NextRequest) {
  try {
    ...
    try {
      ...
      console.log("Fetched employees from users collection:", employees.length)
    ...
    console.log("Sample employee data:", transformedEmployees[0])
    console.log("Employees with birth dates:", transformedEmployees.filter(emp => emp.birth_date).length)
